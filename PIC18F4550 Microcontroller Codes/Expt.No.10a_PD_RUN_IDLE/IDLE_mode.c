...
void main()					//Main Program
{
	...
	OSCCONbits.IDLEN = 1;	//Setting for IDLE MODE 
	PORTD = 0x04;			//Turn ON second LED (L1) to indicate IDLE Mode
	_asm
		sleep				//Execute SLEEP instruction to move from RUN to IDLE
	_endasm
