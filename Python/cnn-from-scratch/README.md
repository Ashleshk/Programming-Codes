...
You may also be interested in [a Neural Network implemented from scratch in Python](https://github.com/Ashleshk/Programming-Codes/tree/master/Python/Neural%20network%20From%20Scratch), which was written for my **introduction to Neural Networks**.
